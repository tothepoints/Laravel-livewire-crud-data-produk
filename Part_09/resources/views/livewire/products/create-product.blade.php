<form wire:submit.prevent="save">
   <div wire:ignore.self class="modal fade" id="modal_create_product" data-backdrop="static" data-keyboard="false"
      tabindex="-1" aria-labelledby="modal_create_product_label" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="modal_create_product_label">Create product</h5>
